...
parser.add_argument('--image_path', default=r'E:\PycharmProject\Datasets\CV\Visdrone2019\Task1\VisDrone2019-DET-test-dev\images',type=str, help="path of images")
parser.add_argument('--label_path', default=r'E:\PycharmProject\Datasets\CV\Visdrone2019\Task1\VisDrone2019-DET-test-dev\labels',type=str, help="path of labels .txt")
parser.add_argument('--save_path', default=r'E:\PycharmProject\Datasets\CV\Visdrone2019\Task1\VisDrone2019-DET-test-dev\data.json', type=str, help="if not split the dataset, give a path to a json file")

...
def get_params():
    params = {
        'weight': 'runs/visdrone/yolov5/yolov5n/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'E:\PycharmProject\Datasets\CV\Visdrone2019\Task1\VisDrone2019-DET-test-challenge\images\0000000_02309_d_0000006.jpg', 'result/yolov5n')

...
# --- 配置 ---
seq8_root = r"E:\PycharmProject\Datasets\CV\seq8"
yolo_root = r"E:\PycharmProject\Datasets\CV\seq8" # YOLO 数据集也存放在同一目录下

images_base_src = os.path.join(seq8_root, "JPEGImages")
annotations_base_src = os.path.join(seq8_root, "Annotations")
